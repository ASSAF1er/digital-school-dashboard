...
export default function DeleteCompte({ handleDelete, account }) {
        ...
        <div>
            ...
            <Snackbar open={open} autoHideDuration={6000} onClose={handleCloseAlert}>
                <Alert onClose={handleCloseAlert} severity="success" sx={{ width: '100%' }}>
                    Compte <span className="font-bold"> {account.name}</span> supprimée avec succès!
                </Alert>
            </Snackbar>
            <Dialog
                open={openBox}
            ...
            >
                ...
                <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                        Souhaitez-vous vraiment supprimer le compte utilisateur au nom de
                        <span className="font-bold"> {account.name}</span> ?
                        <br /> Toutes les informations y afférentes seront perdues.
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
